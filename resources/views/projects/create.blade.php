        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                <div class="bg-blue-900 px-6 py-4 border-b border-blue-800 flex justify-between items-center">
                    <h3 class="text-white font-bold uppercase text-sm tracking-wide">Project Details</h3>
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="project_name" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="project_name" required autofocus placeholder="e.g. Headquarters Renovation" />
                        ...
                        <div class="mb-8">
                            ...
                            <x-text-input id="project_address" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="project_address" placeholder="e.g. 123 Main St, Cityville" />
                        </div>
