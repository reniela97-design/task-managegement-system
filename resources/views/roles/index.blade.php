    ...
    <div class="bg-white border-b border-gray-200 shadow-sm">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div class="text-sm font-medium text-gray-500">
                Total Roles: <span class="text-blue-900 font-bold">{{ $roles->count() }}</span>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-blue-900 px-6 py-4 border-b border-blue-800 flex justify-between items-center">
                    ...
                    <a href="{{ route('roles.create') }}" class="bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold py-2 px-4 rounded shadow-lg shadow-blue-900/50 transition uppercase tracking-wide flex items-center gap-2">
                            ...
                            <tr class="hover:bg-blue-50 transition group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-bold text-gray-800 text-sm group-hover:text-blue-900 transition">{{ $role->role_name }}</span>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-2">
                                        ...
                                        @if($role->role_name !== 'Administrator')
                                            <form action="{{ route('roles.destroy', $role->role_id) }}" method="POST" onsubmit="return confirm('Delete this role? This cannot be undone.');">
                                                @csrf
                                                @method('DELETE')
