                    ...
                    <form method="POST" action="{{ route('clients.update', $client->client_id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <x-text-input id="client_contact_person" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="client_contact_person" :value="old('client_contact_person', $client->client_contact_person)" />
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="client_contact_number" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="client_contact_number" :value="old('client_contact_number', $client->client_contact_number)" />
                            </div>
                        </div>
