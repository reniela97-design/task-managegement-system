            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                <div class="bg-blue-900 px-6 py-4 border-b border-blue-800 flex justify-between items-center">
                    <h3 class="text-white font-bold uppercase text-sm tracking-wide">
                        Editing: <span class="text-blue-200">{{ $user->user_name }}</span>
                    </h3>
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('users.update', $user->user_id) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="user_name" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="text" name="user_name" :value="old('user_name', $user->user_name)" required />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="user_email" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="email" name="user_email" :value="old('user_email', $user->user_email)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div class="{{ !(auth()->user()->hasRole('Administrator') || auth()->user()->hasRole('Manager')) ? 'col-span-2' : '' }}">
                                <x-input-label for="user_password" :value="__('New Password')" class="text-blue-900 font-bold uppercase text-xs tracking-wider mb-2" />
                                <x-text-input id="user_password" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-900 focus:ring-blue-900" type="password" name="user_password" autocomplete="new-password" placeholder="Leave blank to keep current" />
